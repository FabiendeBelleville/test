...
public class CustomerDaoImpl extends AbstractDaoJdbc implements CustomerDao {
	...
	@Override
	public Customer findById(int id) throws MyBusinessException{
		Customer cust = null;
		Connection cn = null;
		...
		try {
			...
			String sql = "select firstname, lastname, age, id from customer where id = ?";
	...
	@Override
	public int create(Customer c) throws MyBusinessException{
		Connection cn = null;
		PreparedStatement st = null;
		int result = -1;
		try {
	...
	@Override
	public int update(Customer c) throws MyBusinessException{
		Connection cn = null;
		PreparedStatement st = null;
		int result = -1;
		try {
	...
	@Override
	public int delete(Customer c) throws MyBusinessException{
		Connection cn = null;
		PreparedStatement st = null;
		int result = -1;
		try {
